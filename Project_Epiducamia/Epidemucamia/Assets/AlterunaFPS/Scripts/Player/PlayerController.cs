...
namespace AlterunaFPS
{
	...
	private new void OnEnable()
	{
		...
		if (_isOwner && _possesed && CinemachineVirtualCameraInstance.Instance != null)
		{
	...
	{
		bool lockInput = LockCameraPosition || (MenuInstance.Instance != null && MenuInstance.Instance.activeSelf);
