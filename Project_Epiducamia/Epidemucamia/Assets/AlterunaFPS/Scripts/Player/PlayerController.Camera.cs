...
namespace AlterunaFPS
{
	...
	private void InitializeCamera()
	{
		...
		{
			Debug.LogWarning("PlayerController: Camera target is not assigned. Please assign FirstPersonCameraTarget and ThirdPersonCameraTarget in the Inspector.");
			return;
		}
		
		if (_isOwner && CinemachineVirtualCameraInstance.Instance != null)
		{
